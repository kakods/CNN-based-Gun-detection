...
Original file is located at
    https://colab.research.google.com/drive/1u2A7QQUHczxdJphdeBj7CILJMrpGOdoX
"""
...
def gun_detection_on_video(learn,name,detect_thresh,classes):
...
def gun_detection_on_image(learn,name,detect_thresh,classes):
